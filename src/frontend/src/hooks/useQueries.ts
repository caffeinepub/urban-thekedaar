...
export function useGetAllQueryForms(enabled = true) {
  const { actor, isFetching: actorFetching } = useActor();
...
export function useGetAllContactForms(enabled = true) {
  const { actor, isFetching: actorFetching } = useActor();
...
export function useGetAllCalculatorLeads(enabled = true) {
  const { actor, isFetching: actorFetching } = useActor();
