...
const FAQ_RESPONSES: Record<string, string> = {
  price:
    "Our construction rates start from ₹1,350/sq ft for Standard, ₹1,450/sq ft for Premium, and ₹1,550/sq ft for Luxury quality. Use our calculator for a detailed estimate!",
  ...
  duration:
    "Project timelines depend on scope. Typically: small homes (800-1200 sq ft) take 6-8 months, medium homes (1200-2000 sq ft) take 8-12 months, and larger projects take 12-18 months.",
  material:
    "We use premium quality materials including AAC blocks, TMT steel, OPC/PPC cement, and vitrified tiles. All materials are sourced from reputed brands.",
  quality:
    "We offer three quality tiers: Standard, Premium, and Luxury. Each tier uses progressively better materials and finishes.",
  contact:
    "You can reach us at +91 9910801994. We're located at DLF City Phase 2, Gurugram.",
  phone:
    "Call us at +91 9910801994. We're available Monday to Saturday, 9 AM to 7 PM.",
  location:
    "We are based in DLF City Phase 2, Gurugram and serve the entire NCR region.",
  gurugram:
    "Yes, we operate across Gurugram and the entire NCR region including Delhi, Noida, and Faridabad.",
  track:
    "We provide live project tracking through our dedicated app. You can monitor progress, view photos, and get real-time updates from anywhere!",
  ...
  engineer:
    "Every project is supervised by a qualified civil engineer. We also provide dedicated site managers for larger projects.",
  permit:
    "Yes, we handle all necessary permits and approvals as part of our Planning & Permits phase.",
  hello:
    "Hello! Welcome to Urban Thekedaar. I'm here to help you with any questions about our construction services. What would you like to know?",
                ...
                <form onSubmit={handleQuerySubmit} className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setQueryForm((p) => ({ ...p, phone: e.target.value }))
                      }
