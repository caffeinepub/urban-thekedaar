...
import { Inbox, Mail, MessageSquare, Phone, Tag, User } from "lucide-react";
import { forwardRef } from "react";

const AdminInquiries = forwardRef<HTMLElement>((_, ref) => {
            ...
            inquiries.length === 0 && (
              <Card className="border-2">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Contact form submissions will appear here once clients reach
                    out.
                  </p>
                </CardContent>
              </Card>
          ...
          {!inquiriesLoading && !error && inquiries && inquiries.length > 0 && (
            <div className="space-y-4">
              {inquiries.map((inquiry, index) => (
                <Card
                  key={`inquiry-${inquiry.phone}-${inquiry.email}`}
