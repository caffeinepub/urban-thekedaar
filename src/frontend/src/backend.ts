...
export class Backend implements backendInterface {
    ...
    async calculateEstimate(arg0: string, arg1: string, arg2: string, arg3: number, arg4: bigint, arg5: string, arg6: string, arg7: bigint, arg8: string, arg9: string): Promise<EstimateResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.calculateEstimate(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCalculatorLeads(): Promise<Array<CalculatorLead>> {
        if (this.processError) {
            try {
    ...
    async getAllQueryForms(): Promise<Array<QueryForm>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllQueryForms();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitQueryForm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitQueryForm(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
